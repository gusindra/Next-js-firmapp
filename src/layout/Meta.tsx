    ...
    <>
      <Head>
        ...
        <link
          ...
          href={`${router.basePath}/assets/favicon_io/apple-touch-icon.png`}
          key="apple"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"
          href={`${router.basePath}/assets/favicon_io/favicon-32x32.png`}
          key="icon32"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href={`${router.basePath}/assets/favicon_io/favicon-16x16.png`}
          key="icon16"
        />
        <link
          rel="icon"
          href={`${router.basePath}/assets/favicon_io/favicon.ico`}
          key="favicon"
        />
